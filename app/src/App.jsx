        ...
        <div style={{
          ...
          {isSpeaking ? (
            ...
            <>
              ...
              {/* 정지 */}
              <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
                <button onClick={ttsHandlers?.stop} style={{ width: '40px', height: '40px', minWidth: '40px', borderRadius: '20px', border: '1px solid var(--nav-border)', background: 'transparent', color: 'var(--text-color)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0' }}>
