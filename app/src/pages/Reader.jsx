        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center', zIndex: 1002, height: '100%', marginLeft: 'auto' }}>
          {isSelectionMode ? (
            ...
            <button className="header-btn" onClick={toggleSelectionMode} title="구절 선택" style={{ width: '32px', height: '32px', padding: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>
            </button>
          )}
        </div>
      </header>
