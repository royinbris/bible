  ...
  return (
    ...
    >
      ...
      <header className="header" style={{
        ...
        padding: 'env(safe-area-inset-top, 24px) 16px 0 16px',
        display: 'flex',
        alignItems: 'center',
      ...
      <main ref={mainRef} style={{ flex: 1, overflowY: 'auto', padding: 'calc(72px + env(safe-area-inset-top, 24px)) 24px 120px' }}>
